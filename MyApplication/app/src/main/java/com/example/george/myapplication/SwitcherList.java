...
public class SwitcherList extends Activity {
    public static final int NUMBER_FER_SCREEN = 8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _li = LayoutInflater.from(SwitcherList.this);
        ...
        {
            String _dataname = "" + i;
            Drawable _drawable = getResources().getDrawable(PokerShow.m_pokerImages[i]);
        ...
        _vs.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                return _li.inflate(R.layout.views,null);
            }
        });
